...
const MailSidebar = ({theme}) => {
  return (

    <div className={`relative bottom-0 left-0 h-screen transition-all duration-300 z-10 overflow-y-auto w-14 md:w-64 ${theme==="dark"?("bg-gray-900 text-gray-100"):("bg-slate-100 text-gray-800")}`}>
      <div className="flex flex-col h-full">
        <div className="overflow-y-auto flex-grow">
          ...
          <p className="mb-14 px-5 py-3 hidden md:block text-center text-xs text-gray-400">Copyright @2021</p>
        </div>
      </div>
    </div>
  );
